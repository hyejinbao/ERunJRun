	...
	<div class="wrap">
		...
		<div class="container">
			...
			<form id="boardUpdateForm">
				<input type="hidden" id="seq" value="${boardDTO.seq }" /> <input
					type="hidden" id="pg" value="${pg }" />
				<table border="1">
					<tr>
						<th width="100">제목</th>
						<td><input type="text" id="subject" name="subject" size="70"
							placeholder="제목 입력" value="${ boardDTO.subject }">
					...
					<tr>
						...
						<td><textarea id="content" name="content" rows="20" cols="70"
								placeholder="내용 입력">${ boardDTO.content }</textarea>
					...
					<tr>
						<td colspan="2" align="center">
							<div style="width: 1100px; margin-top: 5px;">
								<input type="button" value="다시작성" id="reset">
								<!-- 버튼 위치수정 -->
								...
								//  $('#repwdDiv').html('비밀번호가 맞지 않습니다');/
									...
									$
											.ajax({
												...
												success : function() {
													alert('글 수정 완료');
													location.href = "/ERunJRun/board/boardMain.do?pg="
															+ $('#pg').val();
												},
												error : function(e) {
													console.log(e);
