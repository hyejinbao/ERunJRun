...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<c:if test="${sessionScope.memberDTO.id != null}">
			...
			<div class="navbar_home" onclick="location.href='./index.do'">
		</c:if>
		<c:if test="${sessionScope.memberDTO.id == null}">
	    	<div class="navbar_home non-active" onclick="location.href='./index.do'">
		</c:if>
...
<<<<<<< HEAD
		  ...
		  <a href="/ERunJRun/image/imageBoard.do">오운완</a>
=======
		 <a href="./board/boardWriteForm.do">게시판</a> <!--오혜진수정 -->
		 		 
		  <a href="../image/imageBoard.do">오운완</a>
>>>>>>> 6567d980f59913b74c120d0ce322febf3b8ef407
